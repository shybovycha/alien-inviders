...
Global PlanetsCnt, ItemCnt, BotCnt, InventoryItemCnt
Global Planet.TPlanet[100], Item.TItem[100], Bot.TBot[100], Inventory.TItem[100]
...
Function create_world()
  ...
  For i=1 To PlanetsCnt
    ...
    EntityPickMode Planet[i]\Entity#, 1
  Next
...
Function trade(initier#, radius#)
  While Not KeyHit(1)
    RenderWorld()

    ;==TRADE==
	For b.TBot = Each TBot
	  If (EntityDistance(initier#, b\entity#) <= radius#) And (b\Race# < 60)
