...
Function main_menu()  
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(maina$(mi#))/2), GraphicsHeight()/2, maina$(mi#)

    If KeyDown(205) Then mi# = mi# + 1
	If KeyDown(203) Then mi# = mi# - 1
...
Function options_menu()  
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(opta$(mi#))/2), GraphicsHeight()/2, opta$(mi#)
...
Function Graphics_options_menu()    
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(optsag$(mi#))/2), GraphicsHeight()/2, optsag$(mi#)
...
Function graphic_driver_menu()
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(optsad$(mi#))/2), GraphicsHeight()/2, optsad$(mi#)
...
Function resolution_options_menu()  
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(optsar$(mi#))/2), GraphicsHeight()/2, optsar$(mi#)
...
Function game_options_menu()
  ...
  While Not KeyHit(1)
    ...
    DrawImage backgrnd, GraphicsWidth()/2 - (ImageWidth(backgrnd)/2), GraphicsHeight()/2 - (ImageHeight(backgrnd)/2)
	Color 255,128,0
	Text GraphicsWidth()/2 - (StringWidth(optsgoa$(mi#))/2), GraphicsHeight()/2, optsgoa$(mi#)
...
If (savename$ <> "") And (f <> 0)
  ...
  If user\Entity# = 0 Then user\Entity = CreateSphere()
  f = ReadFile(savename$)
    ...
    For i=1 To PlanetsCnt
	  ...
	  If Planet[i]\Entity# = 0 Then Planet[i]\Entity# = CreateSphere()
	  tex = LoadTexture("Images/earth.bmp")
	  EntityTexture Planet[i]\Entity#, tex
	  FreeTexture tex
	  EntityPickMode Planet[i]\Entity#, 2
	...
	For i = 1 To BotCnt
	  ...
	  If Bot[i]\Entity# = 0 Then Bot[i]\Entity = CreateSphere()
